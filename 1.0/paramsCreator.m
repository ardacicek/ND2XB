...
paramstxt = ["%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%";
    ...
    "%%% Edit parameters: xfile, yfile, nx, ny, depfile                           %%%";
    ...
    "";
    "npoints = 10"; % Number of output point locations (should be compatible with the number of points given below)
    "3.5	0.575"; % x and y coordinates of gauges
    "6.5	0.575";
    "9	0.575";
    "10.5	0.575";
    "12	0.575";
