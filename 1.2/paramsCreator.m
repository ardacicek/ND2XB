...
paramstxt = ["%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%";
    ...
    "";
    "nonhq3d = 0"; % Turn on or off the the reduced two-layer nonhydrostatic model, default = 0 (= 1 is better for ridiculous fluctuations)
...
paramstxt(45,1) = "xfile = " + outputFileNames(2,1) + ".grd";
paramstxt(46,1) = "yfile = " + outputFileNames(3,1) + ".grd";
paramstxt(49,1) = "nx = " + string(ncols - 1);
paramstxt(50,1) = "ny = " + string(nrows - 1);
paramstxt(52,1) = "depfile = " + outputFileNames(1,1) + ".dep";
